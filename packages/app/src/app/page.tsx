  ...
  return (
        <section className="container mx-auto px-4 pt-16 pb-24">
          <div className="flex flex-col items-center text-center mb-8">
            <Badge className="mb-4 bg-cyan-900/30 text-cyan-400 border-cyan-500/50 tracking-widest">
              PROTOCOL v1.0.3
            </Badge>
            <h1 className="text-5xl md:text-7xl font-bold tracking-wider mb-4 bg-gradient-to-r from-cyan-400 to-green-400 bg-clip-text text-transparent">
              VERIGREEN
            </h1>
